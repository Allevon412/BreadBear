...
//type used to dynamically resolve loadLibrary.
typedef	HMODULE (WINAPI* t_LoadLibraryW)(
	 LPCWSTR lpLibFileName
);
//type used to dynamically resolve FreeLibrary.
//typedef BOOL (WINAPI* t_FreeLibrary)(
//	HMODULE hLibModule
//);

//function definitions for writing files.
...
typedef HWND (WINAPI* t_GetConsoleWindow)(void);

typedef BOOL (WINAPI* t_ShowWindow)(
	HWND hWnd,
	int  nCmdShow
);